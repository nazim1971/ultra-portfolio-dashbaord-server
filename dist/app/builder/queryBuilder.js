...
class QueryBuilder {
    ...
    priceRange() {
        var _a, _b;
        const minPrice = ((_a = this === null || this === void 0 ? void 0 : this.query) === null || _a === void 0 ? void 0 : _a.minPrice)
            ? Number(this.query.minPrice)
            : undefined;
        const maxPrice = ((_b = this === null || this === void 0 ? void 0 : this.query) === null || _b === void 0 ? void 0 : _b.maxPrice)
    ...
    filterByBedrooms() {
        var _a;
        const bedrooms = ((_a = this === null || this === void 0 ? void 0 : this.query) === null || _a === void 0 ? void 0 : _a.bedrooms)
    ...
    filterByLocation() {
        var _a;
        const location = (_a = this === null || this === void 0 ? void 0 : this.query) === null || _a === void 0 ? void 0 : _a.location;
        if (location) {
            this.modelQuery = this.modelQuery.find({
